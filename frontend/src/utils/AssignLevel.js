const assignLevel = (score) => {
  if (score < 100) return "Promeneur curieux";
  if (score >= 100 && score < 200) return "Curious Stroller";
  if (score >= 200 && score < 500) return "Beginner of Alleys";
  if (score >= 500 && score < 700) return "Sketch Seeker";
